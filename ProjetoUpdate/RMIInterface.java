...
public interface RMIInterface extends Remote{
    ...
    /*
    public String pesquisaArtistaRMIServer(String username, String password) throws RemoteException;
    public String pesquisaAlbumRMIServer(String username, String password) throws RemoteException;

	public String consultarDetalhesArtistaRMIServer(String username, String password) throws RemoteException;    
	public String consultarDetalhesAlbumRMIServer(String username, String password) throws RemoteException;

	public String escreverCriticaAlbumRMIServer(String username, String password) throws RemoteException; 
	*/
