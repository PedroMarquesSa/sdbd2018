...
public class RMIServer extends UnicastRemoteObject implements RMIInterface{
    ...
    @Override
    public String pesquisarArtistaRMIServer(String artist_name) throws RemoteException{
        int serverID = 1;

        Random rand = new Random();
        int id = rand.nextInt(999999999) + 1;

        String protocol = "type|artist_details;artist_name|"+artist_name+";id|"+id+";serverId|"+serverID+";status|null;";
        System.out.println(protocol+"\n");
