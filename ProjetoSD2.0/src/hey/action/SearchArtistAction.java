...
public class SearchArtistAction extends ActionSupport implements SessionAware { //session do utilizador que esta realmente a interagir (guardamos a sessao par podermos partilhar entre acçoes
	...
	public String execute() {
		...
		if (this.artist_name != null && !artist_name.equals("")) {
			...
			try {
				resposta = this.getDropMusicBean().pesquisarArtista(artist_name);
